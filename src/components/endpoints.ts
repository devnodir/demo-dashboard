...
export const FINANCES_ANALYTICS = "/finances/analytics";
...
export const INTEGRATION_SMS = "/integrations/sms";
export const APPOINTMENTS_LAST_MONTH = "/analytics/appointments/last-month";
